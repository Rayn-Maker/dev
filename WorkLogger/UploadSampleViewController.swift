...
//  WorkLoggerWebCopy
//
//  Created by Radiance Okuzor on 11/17/17.
...
class UploadSampleViewController: UIViewController, AVAudioRecorderDelegate, UITextFieldDelegate/*, UIPickerViewDataSource, UIPickerViewDelegate */ {
...
//        if let messages:[String:[String]] = UserDefaults.standard.object(forKey: "messagesDict") as? [String:[String]] {
//            self.messageAndProfil = messages
//        }
...
//            getDire().appendingPathComponent("\(numberOfRecords).m4a")
    ...
    func uploadMe(recepientName: String) {
        ...
        uploadRequest?.bucket = "wlw-jobmarket/\(UserDefaults.standard.object(forKey: "email") ?? "nil")/Audio Files"
